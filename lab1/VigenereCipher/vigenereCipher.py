...
with open('lab1/VigenereCipher/message.txt') as message:
    message = message.read()

with open('lab1/VigenereCipher/key.txt') as key:
    key = key.read()

istring = encrypt(message, key)
# writing output to a file
file.writeFile("outputFile.txt", istring)

# checking the decrypt function
dstring = decrypt(istring, key)
